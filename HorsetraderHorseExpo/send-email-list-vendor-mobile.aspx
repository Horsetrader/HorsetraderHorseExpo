<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send-email-list-vendor-mobile.aspx.cs" Inherits="HorsetraderHorseExpo.send_email_list_vendor_mobile" %>
    ...
    <form id="form1" runat="server" role="form">
        ...
        <div id="emailForm" runat="server">
            ...
            <div class="form-group">
                <label class="control-label" for="friendemail">Your Friend's Email:</label>
            ...
            <div class="form-group">
                <label class="control-label" for="comments">Note:</label>
