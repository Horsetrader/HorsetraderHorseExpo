<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="event-details2.aspx.cs" Inherits="HorsetraderHorseExpo.event_details2" %>
...
<body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <h3 id="eventName" runat="server"></h3>
          <p class="text-primary">
            <strong>Event type </strong> - <span id="eventType" runat="server">Clinics</span>
            <br>
            <strong>Location </strong> - <span id="eventLocation" runat="server">Strong Arena</span>
            <br>
            <span id="eventBoothNumber" runat="server"></span>
          </p>
        ...
        <div class="col-xs-12 col-sm-12">
          <div class="event-details-container">
            <div class="row">
              ...
              <div id="eventDescription" runat="server" class="col-xs-12 col-sm-6 text-center"></div><!--/span-->

              <div id="eventVideoContainer" runat="server" class="col-xs-12 col-sm-6">
                <div id="eventVideo" runat="server" class="video-container"></div>
              </div><!--/span-->
              ...
              <div class="col-xs-12 col-sm-12 text-center">
                <div class="button-container">
                  ...
                  <a id="sendEmailClinician" runat="server" class="btn btn-primary modalButton visible-sm visible-md visible-lg" role="button" 
                    data-toggle="modal" data-target="#emailModal" data-title="Email Clinician">
                    <span class="glyphicon glyphicon-envelope"></span> Email clinician
                  </a>
                  <a id="sendEmailClinicianMobile" runat="server" class="btn btn-primary visible-xs" role="button" >
