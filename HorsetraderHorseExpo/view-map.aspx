<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view-map.aspx.cs" Inherits="HorsetraderHorseExpo.view_map" %>
...
<body>
	<a id="goBack" runat="server" class="btn btn-xs btn-primary" role="button">
