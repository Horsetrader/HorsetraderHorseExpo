<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send-email-vendor.aspx.cs" Inherits="HorsetraderHorseExpo.send_email_vendor" %>
    ...
    <form id="form1" runat="server" class="form-horizontal" role="form">
        ...
        <div id="emailForm" runat="server">
            ...
            <div class="form-group">
                <label class="col-xs-3 control-label" for="fullname">Name:</label>
                <div class="col-xs-7">
            ...
            <div class="form-group">
                <label class="col-xs-3 control-label" for="comments">Questions / Comments:</label>
                <div class="col-xs-7">
