<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="send-email-friend-mobile.aspx.cs" Inherits="HorsetraderHorseExpo.send_email_friend_mobile" %>
...
<body>
    <form id="form1" runat="server" role="form">
        ...
        <div id="emailForm" runat="server">
            ...
            <div class="form-group">
                <label for="lastname">Please complete the following form to send your email:</label>
